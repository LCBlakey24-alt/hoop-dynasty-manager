...
import { clearLocalSeasonSave, exportLocalSeasonSave, getBackupLocalSeasonSaveMeta, importLocalSeasonSave, loadLocalSeasonSave, restoreBackupLocalSeasonSave, saveLocalSeason } from './game/localSave';
    ...
    <section className="dashboard-grid">
      ...
      <article className="panel wide-panel save-panel">
        ...
        <div className="option-row" style={{ marginBottom: '0.75rem' }}>
          ...
          <button className="option-button" onClick={handleRestoreBackupSave}>Restore Backup</button>
        </div>
